  ...
  return (
    <div className="pt-32 pb-24 max-w-[1440px] mx-auto px-5 md:px-16">
      ...
      <header className="mb-20 text-center max-w-3xl mx-auto">
        ...
        <h1 className="font-serif text-4xl md:text-6xl text-primary font-normal mb-6">
          Our Heritage & Craft
        </h1>
      ...
      <section className="mb-28">
        <div className="glass-panel p-4 md:p-8 rounded-3xl overflow-hidden shadow-2xl border border-black/5">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 p-4 space-y-6">
              <span className="font-sans text-xs tracking-[0.25em] uppercase text-secondary">
                Purity of Material
              </span>
              <h2 className="font-serif text-3xl text-primary font-normal leading-tight">
      ...
      {/* Three Pillars */}
      <section className="mb-28 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="glass-panel p-8 rounded-3xl space-y-4 border border-black/5">
          ...
          <h3 className="font-serif text-2xl text-primary font-normal">FSC-Certified Timber</h3>
          <p className="font-sans text-xs text-secondary leading-relaxed font-light">
        ...
        <div className="glass-panel p-8 rounded-3xl space-y-4 border border-black/5">
          ...
          <h3 className="font-serif text-2xl text-primary font-normal">Artisanal Guilds</h3>
          <p className="font-sans text-xs text-secondary leading-relaxed font-light">
        ...
        <div className="glass-panel p-8 rounded-3xl space-y-4 border border-black/5">
          ...
          <h3 className="font-serif text-2xl text-primary font-normal">Lifetime Guarantee</h3>
          <p className="font-sans text-xs text-secondary leading-relaxed font-light">
      ...
      <section className="bg-surface-container-low rounded-3xl p-12 text-center max-w-3xl mx-auto border border-black/5">
        <h2 className="font-serif text-3xl md:text-4xl text-primary font-normal mb-4">
          Experience Aurelian Firsthand
        </h2>
        <p className="font-sans text-xs text-secondary mb-8 max-w-md mx-auto font-light">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link
            to="/contact"
            className="bg-primary text-on-primary font-sans text-xs tracking-[0.2em] uppercase px-8 py-3.5 rounded-full hover:bg-surface-tint shadow-lg"
          >
            Book Private Consultation
          </Link>
          <Link
            to="/collections"
            className="border border-primary text-primary font-sans text-xs tracking-[0.2em] uppercase px-8 py-3.5 rounded-full hover:bg-black/5"
          >
            Browse Collections
          </Link>
        </div>
